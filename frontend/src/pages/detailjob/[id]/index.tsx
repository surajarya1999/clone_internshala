...
const index = () => {
    ...
    useEffect(() => {
        const fetchdata = async () => {
            try {
                const res = await axios.get(`https://clone-internshala.onrender.com/api/job/${id}`);
                setjob(res.data);
            } catch (error) {
                console.log(error);
            }
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="p-6 border-b">
                    <h2 className="text-xl font-bold text-gray-900 mb-4">
                        {t("aboutCompany")} {jobdata.company}
                    </h2>
